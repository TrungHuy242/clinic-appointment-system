...
from .views import (
    ...
    ReceptionMoveToWaitingAPIView,#thêm vào
)
...
urlpatterns = [
    ...
    path('reception/move-to-waiting/<str:lookup_value>/',ReceptionMoveToWaitingAPIView.as_view(),name='reception-move-to-waiting'),
]
