...
from .views import (
    ...
    DoctorScheduleConfigAPIView,
    DoctorTimeOffAPIView,
...
urlpatterns = [
    ...
    path('patient/auth/verify-otp/', PatientVerifyOtpAPIView.as_view(), name='patient-auth-verify-otp'),
    path('patient/auth/forgot-password/send-otp/', ForgotPasswordSendOtpAPIView.as_view(), name='forgot-password-send-otp'),
    path('patient/auth/forgot-password/reset/', ForgotPasswordResetAPIView.as_view(), name='forgot-password-reset'),
    ...
    path('patient/records/', PatientMedicalRecordsAPIView.as_view(), name='patient-medical-records'),
    ...
    path('doctor/schedule-config/', DoctorScheduleConfigAPIView.as_view(), name='doctor-schedule-config'),
    path('doctor/time-off/', DoctorTimeOffAPIView.as_view(), name='doctor-time-off'),
