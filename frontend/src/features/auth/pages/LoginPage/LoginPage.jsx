...
import { useAuth, ROLES, ROLE_ROUTES } from "../../../../shared/services/AuthContext";
...
export default function LoginPage() {
  ...
  async function handleSubmit(event) {
    ...
    try {
      if (loginType === "staff") {
        const response = await appointmentApi.staffLogin({ username: form.username, password: form.password });
        if (response.success) {
        ...
        const response = await appointmentApi.login({ identifier: form.identifier, password: form.password });
        if (response.success) {
