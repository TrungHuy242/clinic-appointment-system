...
const QUEUE_STATUS = {
  ...
  in_progress: { label: "Äang khám", variant: "info" },
...
const RX_HEADER_CONFIG = [
  ...
  { key: "unit", label: "Äơn vị", className: "visit-page__rx-head--unit" },
...
export default function VisitPage() {
  ...
  async function handleSaveDraft() {
    ...
    try {
      ...
      showToast("Äã lưu nháp thành công.");
    } catch {
  ...
  async function handleComplete() {
    ...
    try {
      ...
      showToast("Äã hoàn tất khám bệnh!");
      ...
      <main className="vt-main">
        ...
        {detail && !loadingDetail && (
          <>
            ...
            <div className="vt-section">
              <div className="vt-section__title">Äơn thuốc</div>
            ...
            <div className="vt-action-bar">
              <Button variant="secondary" onClick={handleSaveDraft} disabled={saving}>
                ...
                {saving ? "Äang lưu..." : "Lưu nháp"}
              </Button>
              <Button onClick={handleComplete} disabled={completing}>
                <Stethoscope className="mc-icon mc-icon--sm" />
                {completing ? "Äang hoàn tất..." : "Hoàn tất khám"}
              </Button>
            </div>
          </>
        )}
