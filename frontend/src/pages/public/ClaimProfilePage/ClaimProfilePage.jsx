...
export default function ClaimProfilePage() {
  ...
  async function handleSubmit(event) {
    ...
    try {
      const result = await authApi.claimProfile(form.appointmentCode, form.fullName);
      ...
      {claimResult && (
        <div className="claim-result">
          ...
          <div className="claim-result__actions">
            <button type="button" className="claim-result__primary" onClick={() => navigate("/app/patient/appointments")}>
